    ...
    <div className="w-full px-6 py-4 z-[-1]">
      <div className="flex flex-col lg:flex-row w-full lg:h-[700px] bg-white py-6">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-start px-4 sm:px-6 lg:px-12 space-y-4 sm:space-y-6">
          {/* Headings */}
          <h1 className="text-[#38393C] font-bold text-xl sm:text-2xl lg:text-5xl leading-tight sm:leading-snug sm:mb-4">
            Transforming Co-Commuting:
          </h1>
          <h1 className="text-[#4CAF50] font-bold text-xl sm:text-2xl lg:text-5xl leading-tight sm:leading-snug mt-0">
            Smarter, Greener, Together
          </h1>

          {/* Description */}
          <p className="text-[#323131] text-4xl md:text-3xl sm:text-base lg:text-xl leading-relaxed max-w-full sm:max-w-[90%] lg:max-w-[75%]">
