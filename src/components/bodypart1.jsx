      ...
      <div className="flex flex-col lg:flex-row w-full h-auto bg-white py-6">
        ...
        <div className="relative w-full lg:w-1/2 flex items-center justify-end bg-white overflow-hidden py-10">
          ...
          <img
            ...
            alt="App2 animation"
            loading="lazy"
            className="absolute top-[10%] left-[15%] w-1/2 h-auto object-cover opacity-80 animate-pulse delay-3000"
          />
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-start px-4 sm:px-6 lg:px-12 space-y-4 sm:space-y-6">
          {/* Headings */}
          <h1 className="text-[#38393C] font-bold text-xl sm:text-2xl lg:text-4xl leading-tight sm:leading-snug sm:mb-4">
            Transforming Co-Commuting:
          </h1>
          <h1 className="text-[#4CAF50] font-bold text-xl sm:text-2xl lg:text-4xl leading-tight sm:leading-snug mt-0">
