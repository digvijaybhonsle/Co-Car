    ...
    <div className="w-full px-6 py-4">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-12 lg:pl-20">
        ...
        <div className="w-full lg:w-1/2 px-4 sm:px-6 lg:px-12">
          <p className="text-[#38393C] text-sm sm:text-base lg:text-xl leading-relaxed pr-8 sm:pr-16 lg:pr-40">
          ...
          <button className="mt-6 bg-[#004E8F] hover:bg-[#00376a] text-white rounded-full w-[200px] sm:w-[220px] lg:w-[250px] h-[50px] flex items-center justify-center shadow-lg transition-all duration-300 cursor-pointer">
            Contact Us
          </button>
        </div>
